namespace StatAnalisys
{
    partial class CClouds
    {
        ...
        private void InitializeComponent()
        {
            ...
            chartArea1.AxisY.Title = "sign(Xcr/Xtr-1)*(Xcr/Xtr)^(sign(Xcr/Xtr-1))";
            ...
            chartArea2.AxisY.Title = "sign(Xcr/Xtr-1)*(Xcr/Xtr)^(sign(Xcr/Xtr-1))";
            ...
            chartArea3.AxisY.Title = "sign(Xcr/Xtr-1)*(Xcr/Xtr)^(sign(Xcr/Xtr-1))";
            ...
            chartArea4.AxisY.Title = "sign(Xcr/Xtr-1)*(Xcr/Xtr)^(sign(Xcr/Xtr-1))";
